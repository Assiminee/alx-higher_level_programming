...
class TestRectangleClass(unittest.TestCase):
    ...
    def test_atts(self):
        ...
        square_atts = [{"size": 4},
                     {"id": sys.maxsize, "size": 4, "x": 7, "y": 8},
                     {"id": 0, "size": 7},
                     {"id": 1, "size": 3, "x": 1},
                     {"id": None, "size": 3, "x": 1, "y": 3},
                     {"id": -3, "size": 3},
                     {"id": "string", "size": 3, "x": 1, "y": 3},
                     {"id": "", "size": 3, "x": 1, "y": 3},
                     {"id": (1, 2), "size": sys.maxsize, "x": 1, "y": 3},
                     {"id": [1], "size": 1, "x": 0, "y": 0},
                     {"id": [], "size": 3, "x": 0, "y": 0},
                     {"id": tuple(), "size": 3, "x": 1, "y": 3},
                     {"id": 3.14, "size": 3, "x": 1, "y": 3},
                     {"id": 1e1000, "size": 3, "x": 1, "y": 3},
                     {"id": (1+5j), "size": 3, "x": 1, "y": 3},
                     {"id": -0.2, "size": 3, "x": 1, "y": 3},
                     {"id": {"key": "value"}, "size": 3},
                     {"id": {}, "size": 3, "x": 1, "y": 3},
                     {"id": {1, 2, 3}, "size": 3},
                     {"id": set(), "size": 3, "x": 1, "y": 3},
                     {"size": 3, "x": sys.maxsize, "y": sys.max_size},
                     {"id": {4}, "size": 3, "x": 1, "y": 3}]

        # Tests if values have correctly been assigned to a Square instance
        for i in range(len(square_atts)):
            parameters = square_atts[i]
            square_inst = Square(**parameters)
            default_id = Base._Base__nb_objects

            expected_atts = {"id": None, "size": None, "x": None, "y": None}
            ...
            for key in square_inst.__dict__.keys():
                square_key = key[12:] if key != "id" else key
                self.assertEqual(square_inst.__dict__[key],
                                 expected_atts[square_key])
